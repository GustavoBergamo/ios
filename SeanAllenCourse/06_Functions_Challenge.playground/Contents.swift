...
// takes no parameters
// simply returns the integer 1 (a seta informa o que vai retornar)
func returnOne() -> Int{
    let a = 1
    return a
}
...
printIntroduction(fname: "Gustavo", lname: "Bergamo")
...
// Answer:More understandable, but it doesn't work here
...
func Area(radius: Double) -> Double {
    var a: Double = ((radius * radius) * 3.14)
    return a
}
...
print("The area is", Area(radius: 6.1))
...
//Because the variable money is just double when called.
//you can change it making receive itself with the function ==>> money = doubleMoney(money)
//or call the function when print ==>> print("The value of money is", doubleMoney(money)
